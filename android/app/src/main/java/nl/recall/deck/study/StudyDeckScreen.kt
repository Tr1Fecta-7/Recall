...
import nl.recall.presentation.deck.study.model.SwipeDirection
                    ...
                    Column(
                        ...
                        Column(
                            ...
                            Image(
                                ...
                                painter = painterResource(id = R.drawable.cards_done_for_today),
                                contentDescription = "cards done for today"
                            )
                            Text(
                                text = stringResource(id = R.string.cards_done_today),
